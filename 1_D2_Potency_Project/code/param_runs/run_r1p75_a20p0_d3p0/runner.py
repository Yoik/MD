...
# 参数（由外部替换）
INTEGRATION_RADIUS = 1.75
ANGLE_SCALE = 20.0
DIST_SCALE = 3.0
OUTPUT_BASE = r'/home/hongyu/MD/1_partial/param_runs/run_r1p75_a20p0_d3p0/results'
MODEL_OUTPUT = r'/home/hongyu/MD/1_partial/param_runs/run_r1p75_a20p0_d3p0/models'
SUMMARY_FILE = r'param_runs/run_r1p75_a20p0_d3p0/summary.json'
